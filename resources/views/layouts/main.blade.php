                ...
                <nav class="navbar navbar-dark bg-dark">
                    ...
                    <nav>
                        <ul class="navs header__navs">
                            ...
                            <li>
                                @if($page == 'categories')
                                    <a href="/categories" class="btn btn-primary btn-sm header__nav-link">Категории</a>
                                @else
                                    <a href="/categories" class="btn btn-secondary btn-sm header__nav-link">Категории</a>
                                @endif
                            </li>
                            <li>
                                @if($page == 'info')
                            ...
                            <li>
                                @if($page == 'login')
                                    <a href="/login" class="btn btn-primary btn-sm header__nav-link">Войти</a>
                                @else
                                    <a href="/login" class="btn btn-secondary btn-sm header__nav-link">Войти</a>
                                @endif
                            </li>
                        </ul>
                    </nav>
